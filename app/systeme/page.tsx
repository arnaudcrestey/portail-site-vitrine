...
const astraeLinkClassName =
  'inline-flex items-center justify-center rounded-full border border-[#d9def8] bg-[#f7f8fe] px-5 py-2.5 text-sm font-medium text-ink shadow-[0_10px_24px_rgba(15,23,42,0.04)] transition hover:-translate-y-0.5 hover:bg-white';
