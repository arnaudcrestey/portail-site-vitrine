...
function MonogramAC() {
  return (
    <div
      className={`${serif.className} relative flex h-[74px] w-[118px] items-center justify-center text-[#0f172a] sm:h-[82px] sm:w-[128px]`}
      aria-label="AC"
    >
      <span className="absolute left-[18px] top-1/2 -translate-y-1/2 text-[72px] font-medium leading-none tracking-[-0.08em] sm:left-[16px] sm:text-[80px]">
        A
      </span>
      <span className="absolute left-[54px] top-1/2 -translate-y-1/2 text-[74px] font-medium leading-none tracking-[-0.09em] sm:left-[56px] sm:text-[82px]">
        C
      </span>
    </div>
  );
        ...
        <div className="grid gap-12 md:grid-cols-[minmax(0,1.15fr)_170px_220px] md:items-start md:gap-16">
          <div className="flex justify-center md:justify-start">
            <div className="max-w-[430px] text-center md:text-left">
              ...
              <p
                className={`${serif.className} mt-6 text-[26px] font-normal leading-[1.55] tracking-[-0.01em] text-[#667085] sm:text-[30px] md:max-w-[540px]`}
              >
